...
export const AccountItem = ({
  ...
  return (
    <Card className='flex flex-col lg:flex-row items-center justify-between p-3 space-y-4 lg:space-y-0'>
      <div className='flex flex-col space-y-2 items-center justify-center text-lg font-light'>
